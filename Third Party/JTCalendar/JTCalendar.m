...
static NSString *kJTCalendarScrolled = @"kJTCalendarScrolled";
...
- (void)updatePage
{
    ...
    [self.delegate dateHasUpdatedWithDate:currentDate];
    self.menuMonthsView.scrollEnabled = YES;
    self.contentView.scrollEnabled = YES;
    [[NSNotificationCenter defaultCenter] postNotificationName:kJTCalendarScrolled object:currentDate];
}
